...
if app_mode=='Home':
    ...
    # Initialize session state for tracking the selected date and prediction
    ...
    if st.button('Predict'):
        if st.session_state.last_prediction_date != selected_date:
            ...
            prediction = prediction + random.randint(-prediction*0.1, prediction*0.1)
